...
const I18N_CONF = {
  ...
  McpServerManagement: {
    ...
    importDialogTitle: '导入 MCP Server',
    importFromPublicRegistry: '从 Public Nacos Registry 导入',
    importFromFile: '从文件导入',
    publicRegistryTab: 'Public Registry',
    fileImportTab: '文件导入',
    serverList: '服务器列表',
    selectServers: '选择要导入的服务器',
    importSelected: '导入选中的服务器',
    importSuccess: '导入成功',
    importFailed: '导入失败',
    ...
    selected: '已选择',
    noDescription: '暂无描述',
    invalidFileFormat: '无效的文件格式，请上传有效的JSON文件',
  },
  McpDetail: {
